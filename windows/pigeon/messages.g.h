...
class WindowsStoreApiCodecSerializer : public flutter::StandardCodecSerializer {
 public:
  WindowsStoreApiCodecSerializer();
  inline static WindowsStoreApiCodecSerializer& GetInstance() {
    static WindowsStoreApiCodecSerializer sInstance;
    return sInstance;
  }
